...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-60 flex-shrink-0 bg-emerald-900 text-white flex flex-col shadow-xl">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1 text-sm">
            ...
            <a href="{{ route('baak.statistik') }}"
               class="flex items-center gap-3 px-3 py-2 rounded-lg transition {{ request()->routeIs('baak.statistik*') ? 'bg-emerald-600 text-white' : 'text-emerald-200 hover:bg-emerald-700' }}">
